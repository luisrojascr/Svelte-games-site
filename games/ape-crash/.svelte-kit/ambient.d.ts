...
declare module '$env/static/private' {
	...
	export const npm_package_scripts_dev_prod: string;
	...
	export const npm_package_scripts_dev_local: string;
	export const npm_package_devDependencies__sveltejs_adapter_static: string;
	export const VSCODE_GIT_ASKPASS_MAIN: string;
	export const npm_package_scripts_localegen: string;
	...
	export const npm_package_scripts_codegen_prod: string;
	export const npm_package_devDependencies__infinitro_test_wrapper: string;
	export const npm_package_devDependencies_autoprefixer: string;
	export const npm_package_scripts_dev_stage: string;
	...
	export const npm_package_scripts_build_local: string;
	export const npm_package_scripts_test_integration: string;
	export const npm_config_frozen_lockfile: string;
	export const DISPLAY: string;
	export const npm_package_scripts_test_unit: string;
	export const npm_package_devDependencies_env_cmd: string;
	export const LANG: string;
	export const npm_package_scripts_codegen_local: string;
	...
	export const npm_package_dependencies__infinitro_global_postauth: string;
	...
	export const npm_package_scripts_upload: string;
	...
	export const npm_package_scripts_build_stage: string;
	export const VSCODE_GIT_ASKPASS_EXTRA_ARGS: string;
	export const npm_package_scripts_format: string;
	export const PWD: string;
	export const npm_package_scripts_codegen_stage: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		LESSOPEN: string;
		npm_package_scripts_dev_prod: string;
		...
		NVM_INC: string;
		npm_package_scripts_dev_local: string;
		npm_package_devDependencies__sveltejs_adapter_static: string;
		VSCODE_GIT_ASKPASS_MAIN: string;
		npm_package_scripts_localegen: string;
		...
		npm_package_scripts_codegen_prod: string;
		npm_package_devDependencies__infinitro_test_wrapper: string;
		npm_package_devDependencies_autoprefixer: string;
		npm_package_scripts_dev_stage: string;
		...
		npm_package_scripts_build_local: string;
		npm_package_scripts_test_integration: string;
		npm_config_frozen_lockfile: string;
		DISPLAY: string;
		npm_package_scripts_test_unit: string;
		npm_package_devDependencies_env_cmd: string;
		LANG: string;
		npm_package_scripts_codegen_local: string;
		...
		TERM_PROGRAM: string;
		npm_package_dependencies__infinitro_global_postauth: string;
		...
		npm_package_scripts_upload: string;
		...
		npm_package_scripts_build_stage: string;
		VSCODE_GIT_ASKPASS_EXTRA_ARGS: string;
		npm_package_scripts_format: string;
		PWD: string;
		npm_package_scripts_codegen_stage: string;
		npm_execpath: string;
		NVM_CD_FLAGS: string;
