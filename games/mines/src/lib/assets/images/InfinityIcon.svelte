<script lang="ts">
	// export let version: string = '1.1';
	// export let id: string = 'Capa_1';
	// export let x: string = '0px';
	// export let y: string = '0px';
	// export let viewBox: string = '0 0 477.867 477.867';
</script>
...
<style lang="postcss">
	.infinity {
		@apply flex justify-center items-center whitespace-nowrap relative top-[7%] pointer-events-none cursor-text right-[0.3em];
		height: 18px;
	}
</style>
