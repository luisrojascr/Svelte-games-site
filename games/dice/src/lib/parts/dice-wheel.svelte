...
<style lang="postcss">
	...
	.filler {
		@apply absolute bg-[#334284] z-[9] w-[5%] h-[5%] left-[47.48%] top-[7%];
	}

	.leftFiller {
		@apply absolute w-[2.329%] z-[9] h-[2.329%] left-[51.3%] top-[8.197%] rounded-[50%];
	}

	.rightFiller {
		@apply absolute w-[2.329%] z-[9] h-[2.329%] left-[46.3%] top-[8.19%] rounded-[50%];
	}

	.number-limit {
		@apply absolute font-bold text-white bg-[#111a41]  border-[1.2px] border-solid border-[#2a335b] leading-[1.33] inline-flex justify-center items-center text-center rounded-[4.8px] py-[1px] px-[5px] w-[4ch] flex-shrink-0;
	}
