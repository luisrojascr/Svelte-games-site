...
<style lang="postcss">
	...
	.buttons-v2 {
		@apply relative inline-flex justify-center items-center flex-shrink-0 rounded-md bg-[#3f4b79] p-[2px] px-[8px] text-xs font-bold leading-[1] tracking-[0.91px] text-center text-[#848aa0] transition-[background-color_300ms_ease_0s,_opacity_300ms_ease_0s,_transform_100ms_ease_0s] mt-4 mb-4;
	}

	.buttons-v2.selected {
		@apply bg-[#4769fc] text-white;
	}
