...
<style lang="postcss">
	...
	.slider-content input[type='range']::-webkit-slider-thumb {
		@apply appearance-none pointer-events-auto shadow-custom relative w-[40px] h-[40px] rounded-[5.6px] bg-[#ffffff] bg-no-repeat cursor-grab bg-[url('../assets/images/ThumbArrows.svg')] bg-center bg-cover;
	}
	...
	.input-slider {
		@apply w-full text-sm absolute z-10 top-0 h-[24px] outline-none pointer-events-none cursor-pointer touch-manipulation appearance-none bg-transparent;
	}
	...
	.dice-slider-wrapper {
		...
		@apply border border-[#313d6b] bg-[#111a41];
		/* Conditional margin */
	...
	.breakpoint-value::after {
		@apply absolute bottom-0 left-1/2 border-solid border-transparent border-0 content-[''] transform -translate-x-1/2 -translate-y-0;
