<script lang="ts">
	import { locale, t } from '$lib/locale/i18n.js';
...
<style lang="postcss">
	...
	div.modal {
		@apply relative bg-primary-900 rounded-lg shadow p-10 border border-100 flex  flex-col justify-between space-y-6 text-white;
	}
	button.close {
