...
<span class="section">
	<div class="input">
		<div class="leading-icon">
			<img src="/icons/bitcoin.svg" alt="BTC" />
		</div>
		<input
			class="input"
			type="text"
...
<style lang="postcss">
	...
	input,
	input:disabled {
		@apply border bg-background-950 border-100 text-white text-base block w-full p-2.5 pl-10 rounded-sm;
	}
	input:focus {
