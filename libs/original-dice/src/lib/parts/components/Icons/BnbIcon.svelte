<script lang="ts">
	// Props that you might want to pass to the icon component, such as styles and attributes
	export let width: string; // default width if not specified by parent
	export let height: string; // default height if not specified by parent
</script>

<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2500.01 2500" fill="#f3ba2f" {width} {height}
